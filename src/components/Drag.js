...
/*
This component will be a container component that will enable dragging on its children. 
It will accept a single prop, dataItem, as an identifier for the data being dragged
*/
const Drag = props => {
